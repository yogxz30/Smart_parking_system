...
def render_login_page():
    ...
    with col_center:
        ...
        header_html = (
            ...
            'font-size:2.4rem;margin-bottom:12px;"><span class="material-symbols-rounded">local_parking</span></div>'
        ...
        with tab_login:
            ...
            with st.form(key="login_form"):
                ...
                submit_login = st.form_submit_button(":material/login: Sign In to Account", use_container_width=True, type="primary")
            ...
            with demo_cols[0]:
                if st.button(":material/person: Demo: John Doe", key="btn_demo_john", use_container_width=True):
                    with st.spinner("Signing in as John Doe..."):
                        ...
                        if result.get("success"):
                            ...
                            st.rerun()
            with demo_cols[1]:
                if st.button(":material/person: Demo: Priya Sharma", key="btn_demo_priya", use_container_width=True):
        ...
        with tab_register:
            ...
            with st.form(key="register_form"):
                ...
                st.markdown("<div style='height: 8px;'></div>", unsafe_allow_html=True)
                submit_reg = st.form_submit_button(":material/person_add: Create My Account", use_container_width=True, type="primary")
